...
public class EscenarioDePartida
{
    ...
    public void setUp()
    {
        ...
        clintePepe = new MailClient(gmailServer, "pepe@gmail.com");
        mailClie1 = new MailClient(gmailServer, "maria@gmail.com");
        clintePepe.sendMailItem("maria@gmail.com", "Hola Maria, soy Pepe!");
